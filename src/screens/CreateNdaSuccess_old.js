            ...
            {showModal_1 ?
              ...
              <View style={styles?.container}>
                ...
                <Text
                  style={{
                    ...styles.titleText,
                    color: theme?.name == 'Light' ? '#2E476E' : theme?.colors?.text,
                    paddingHorizontal: 30,
                    lineHeight: 40,
                  }}
                >
                  {type == 'sender' ? isDraft ? 'NDA saved as draft Successfully' : 'NDA Sent Successfully' : 'Signed in NDA Successfully'}
                </Text>
                ...
                >
                  {type == 'sender' ? isDraft ? '' : 'We will notify you once it’s signed or there is any change request' : 'We will notify Sender'}
                </Text>

                <View style={{ marginVertical: 50, zIndex: 10000 }}>
                  <CustomButton
                    title={'Back To Home'}
