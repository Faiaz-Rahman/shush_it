const LOCAL = 'http://192.168.0.119:8000'; ///'http://192.168.0.166:8000'; //'https://devapi.varanin.com';
const STAGING = 'https://sush-app.prolificlogic.com'; //'https://tour-app.prolificlogic.com'; //
const BASE_URL = STAGING; // LOCAL; ////'http://192.168.0.166:8000'; //'https://devapi.varanin.com';
